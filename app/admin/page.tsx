...
// 🔴 **배열 순서가 곧 화면 순서다**(리뷰 2·3라운드에 사용자가 직접 지정).
//    1행: 견적 관리 · 운송오더 · 배차 관리 · 정산 관리   ← **매일 만지는 실행 화면**
//    2행: 화주 관리 · 활성 화주 · 차주 관리 · 운임기준표  ← 대상·기준
//    ⚠️ 2라운드에는 두 줄이 **반대**였다(대상·기준이 위). 3라운드에 사용자가
//       *"1행과 2행의 내용을 교체하자"* 로 뒤집은 것이니 옛 기록을 근거로 되돌리지 말 것.
//    항목을 더하면 4의 배수를 지켜야 4칸 2줄이 유지된다.
const MENU = [
  {
    href: "/admin/quotes",
    tag: "견적",
