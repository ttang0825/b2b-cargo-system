        ...
        <section className="guide-section" aria-labelledby="guide-steps">
          ...
          <div className="card guide-card">
            ...
            <ol className="guide-ol">
              <li>
                이 홈페이지에서 <b>「화주 등록신청」</b>을 작성하시거나, 담당자에게 말씀만 주셔도 저희가 대신
                등록해 드립니다
              </li>
            ...
            {/* 🔴 문의 1번(아이디를 이메일로 착각한다)에 대응하는 문장이다. 지우지 말 것.
                🟢 아이디 형식을 함께 적은 근거 — 로그인 실패 응답이 「없는 아이디」와
                   「비밀번호 틀림」으로 갈리지 않아(화면이 한 문구로 뭉갠다) 형식을 알아도
                   계정이 있는지 없는지를 가릴 수 없다. 형식 자체도 이미 공개된 값이다. */}
            <p className="guide-note">
              ⚠️ <b>아이디는 이메일이 아닙니다.</b> 위캐리가 발급하는 전용 아이디이고, 이메일 주소로는
              로그인되지 않습니다. <code className="guide-code">we</code> + 발급일 6자리 + 순번 2자리 형태입니다.
            </p>
          </div>
