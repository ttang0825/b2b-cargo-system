...
> 🔴 이 문서(`CLAUDE.md`)는 **377,817자**입니다(2026-09-21 리워드 1차 리뷰 5라운드 반영 직후) —
> 컨텍스트 예산 판단에 쓰는 값입니다. ⚠️ 그 직전에는 374,517자, 그 앞에는 365,053자였습니다.
...
| `docs/history/current.md` | 이용가이드 재작성 #175 2026-09-18  →  기업고객 리워드 1차 #180 2026-09-21   (6건) | 58,911자 |
...
```
  ...
  ⚠️ 안 한 것       🟢 **소급 적립은 만들었다**(위) — 「후보 0건이라 안 만든다」는 낡았다.
                  화주포털 리워드 카드·적립내역(2차 · `portal_visible` 첫 독자) · 문자 안내(2차) ·
