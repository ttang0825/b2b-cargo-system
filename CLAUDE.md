...
> 🔴 이 문서(`CLAUDE.md`)는 **384,020자**입니다(2026-09-21 리워드 2차 merge 직후) —
> 컨텍스트 예산 판단에 쓰는 값입니다. ⚠️ 그 직전에는 377,817자, 그 앞에는 374,517자였습니다.
> ⚠️ **`wc -m` 으로 세지 마십시오** — 이 환경은 locale 이 UTF-8 이 아니라 **바이트**가 나옵니다
> (한글 섞인 글은 실제의 약 1.9배). `python3` 의 `len()` 으로 세십시오.
> ⚠️ **`current.md` 는 지금 68,582자입니다**(상한 80,000자 · 2026-09-21 리워드 2차 직후).
...
| `docs/history/current.md` | 이용가이드 재작성 #175 2026-09-18  →  기업고객 리워드 2차 #181 2026-09-21   (7건) | 68,582자 |
