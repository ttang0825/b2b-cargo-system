...
커밋 15개(본작업 6 + **실사용 리뷰 4라운드 9**). **PR #105.**
...
🔴 **⑤ 제3자 제공 동의는 세부 4항목만 접는다.** 🔴 **고지 문장(intro)과 거부권 안내
(refusal), 체크박스는 접힌 상태에서도 보인다** — 개인정보보호법 제15조 2항이 고지와
거부권 안내를 요구하므로 그것까지 접으면 동의 자체가 부실해진다. **「자세히 보기」 안으로
intro·refusal 을 옮기지 말 것.** 접는 것은 제공받는 자·목적·항목·기간 4항목과 확인 문장뿐이다.
