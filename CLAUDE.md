...
> 🔴 이 문서(`CLAUDE.md`)는 **261,898자**입니다(2026-09-16 알림 4건 #162 직후) —
> 컨텍스트 예산 판단에 쓰는 값입니다. ⚠️ 그 직전에는 256,742자, 그 앞에는 252,456자였습니다.
...
| `docs/history/current.md` | 운송오더 3건 2026-09-15  →  알림 4건 #162 2026-09-16   (8건) | 63,214자 |
