...
**═══ ⑪ ⚠️ 다음 차수가 알아야 할 것 ═══**
🔴 **다음은 29차(포털 조회 흐름)이고 시안이 있어야 착수한다.** P0 2건은 이번에 끝났으니
29차 지시서에서 빼도 된다.
...
```
  화면 4개(dispatches·invoices·stats·profile)   변경 파일 0 (29차)
  홈 배차 배지 3단계 매핑                        29차 (배차 화면과 공용 매핑을 한 번에)
  캘린더 진입 경로                               29차(월별 통계 하단)
...
```
  ...
  29차  화주포털 조회 흐름          ← 다음. 🔴 **시안이 있어야 착수한다**
...
기계적으로 옮길 수 있다.
🔴 **29차(조회 흐름)는 시안이 있어야 착수한다** — "시안대로"가 조건인데 시안이 없으면
25차 → 26차(시안 정합)를 한 번 더 반복하게 된다.
