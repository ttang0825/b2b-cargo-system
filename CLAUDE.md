...
**작성일: 2026-07-23** (최종 갱신: 2026-08-21, Claude Code 세션에서 직접 갱신 — 43차
...
⚠️ **아직 못 한 검증 1건**: 이 실행 환경에 Supabase 자격증명이 없어 **실제 저장·롤백은 확인하지
못했다.** 마이그레이션 실행 후 Preview에서 양쪽 폼을 제출해 `consents` 행을 눈으로 확인할 것.
