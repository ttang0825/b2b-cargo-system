...
> 🔴 이 문서(`CLAUDE.md`)는 **346,252자**입니다(2026-09-18 문자 발송 정리 #176 기록 직후) —
> 컨텍스트 예산 판단에 쓰는 값입니다. ⚠️ 그 직전에는 341,679자, 그 앞에는 337,330자였습니다.
> ⚠️ **`wc -m` 으로 세지 마십시오** — 이 환경은 locale 이 UTF-8 이 아니라 **바이트**가 나옵니다
> (한글 섞인 글은 실제의 약 1.9배). `python3` 의 `len()` 으로 세십시오.
> ⚠️ **`current.md` 를 `history-18.md` 로 갈랐습니다**(2026-09-18 · 39차 D장 #166 ·
...
| `docs/history/current.md` | 랜딩 히어로 사진·헤더 로고 #169 2026-09-17  →  문자 발송 정리 #176 2026-09-18   (8건) | 70,579자 |
