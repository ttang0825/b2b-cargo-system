...
> 🔴 이 문서(`CLAUDE.md`)는 **330,638자**입니다(2026-09-17 공지사항 간이 서식 #174 직후) —
> 컨텍스트 예산 판단에 쓰는 값입니다. ⚠️ 그 직전에는 324,173자, 그 앞에는 316,337자였습니다.
> ⚠️ **`current.md` 를 `history-17.md` 로 갈랐습니다**(2026-09-17 · 39차 #165 · 포털 알림 #164 ·
...
| `docs/history/current.md` | 포털 알림 4건 #164 2026-09-16  →  공지사항 간이 서식 #174 2026-09-17   (9건) | 76,608자 |
