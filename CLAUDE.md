...
> 🔴 이 문서(`CLAUDE.md`)는 **229,795자**입니다(2026-09-15 운임기준표 v12 #156·#157·#158 직후) —
> 컨텍스트 예산 판단에 쓰는 값입니다. ⚠️ 그 직전에는 222,292자, 그 앞에는 220,180자였습니다.
...
| `docs/history/current.md` | 36차 PR 2 #151 2026-09-15  →  운임기준표 v12 #158 2026-09-15   (7건) | 49,352자 |
