...
> 🔴 이 문서(`CLAUDE.md`)는 **214,412자**입니다(2026-09-15 월정산 묶음 개편 #154 직후) —
> 컨텍스트 예산 판단에 쓰는 값입니다. ⚠️ 그 직전에는 208,929자, 그 앞에는 205,449자였습니다.
...
| `docs/history/current.md` | 거래처 온보딩 `/guide` 2026-09-14  →  월정산 묶음 개편 #154 2026-09-15   (10건) | 66,189자 |
