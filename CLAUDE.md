...
⚠️ **(A) 를 고르면 숙제 하나** — 포털 2화면의 「월정산」. 🔴 **권장: 축을 쪼갠다** —
「운임 수금방식: 위캐리 수금」 + 「청구: 월정산」 **두 줄**. 화주 말 함수를 안 건드리고도
월정산이라는 사실이 살아남는다. ⚠️ **월정산이 실제로 돌기 시작하면 (B) 를 다시 볼 것.**
...
```
  ...
  30차  내부 정합 ① 견적·오더        🔴 **월정산 두 칸을 먼저 정해야 한다**(28차 §10-1)
  31차  내부 정합 ② 배차·정산
  32차  내부 정합 ③ 화주·차주
```
