...
> 🔴 이 문서(`CLAUDE.md`)는 **391,970자**입니다(2026-09-21 리워드 3차 merge 직후) —
> 컨텍스트 예산 판단에 쓰는 값입니다. ⚠️ 그 직전에는 384,020자, 그 앞에는 377,817자였습니다.
> ⚠️ **`wc -m` 으로 세지 마십시오** — 이 환경은 locale 이 UTF-8 이 아니라 **바이트**가 나옵니다
> (한글 섞인 글은 실제의 약 1.9배). `python3` 의 `len()` 으로 세십시오.
> ⚠️ **`current.md` 는 지금 77,432자입니다**(상한 80,000자 · 2026-09-21 리워드 3차 직후).
> 🔴 **다음 차수에 `history-21.md` 로 갈라야 합니다** — 상한까지 2,568자밖에 안 남았습니다.
> ⚠️ **`current.md` 를 `history-20.md` 로 갈랐습니다**(2026-09-20 · 공지사항 간이 서식 #174 ·
...
| `docs/history/current.md` | 이용가이드 재작성 #175 2026-09-18  →  기업고객 리워드 3차 #182 2026-09-21   (8건) | 77,432자 |
