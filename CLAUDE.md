...
> 🔴 이 문서(`CLAUDE.md`)는 **359,254자**입니다(2026-09-18 라보 운임 통일 #178 기록 직후) —
> 컨텍스트 예산 판단에 쓰는 값입니다. ⚠️ 그 직전에는 354,200자, 그 앞에는 346,252자였습니다.
...
| `docs/history/current.md` | 배차취소 후속 #172 2026-09-17  →  라보 운임 통일 #178 2026-09-18   (7건) | 63,345자 |
