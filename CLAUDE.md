...
> 🔴 이 문서(`CLAUDE.md`)는 **191,127자**입니다(2026-09-14 화주포털 이용가이드 PR #149 직후) —
> 컨텍스트 예산 판단에 쓰는 값입니다. ⚠️ 그 직전에는 185,273자, 그 앞에는 177,701자였습니다.
...
| `docs/history/current.md` | 34차 #141 2026-09-10  →  화주포털 이용가이드 `/customer/guide` #149 2026-09-14   (9건) | 73,156자 |
