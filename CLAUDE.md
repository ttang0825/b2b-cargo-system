...
> 🔴 이 문서(`CLAUDE.md`)는 **236,835자**입니다(2026-09-16 24시콜 v4 차수 변경 직후) —
> 컨텍스트 예산 판단에 쓰는 값입니다. ⚠️ 그 직전에는 232,813자, 그 앞에는 229,795자였습니다.
...
| `docs/history/current.md` | 36차 PR 2 #151 2026-09-15  →  24시콜 v4 차수 변경 2026-09-16   (9건) | 59,863자 |
...
```
  ...
  37차  24시콜 가져오기 ⓐ — 배차 정보 채우기   ← **다음**   ⏳ **복사 텍스트 샘플 1건 대기**
...
```
  ...
  ⏳ 남은 것 하나   **복사 텍스트 샘플 1건**(사용자 제공 · 가짜 값으로 치환). 🔴 **샘플 없이
                  지시서를 쓰지 않는다** — v4 자신의 규칙이다. 볼 것 넷: 라벨 구분자 · 빈 칸 처리 ·
                  선택형 포함 여부 · 금액 구분기호
