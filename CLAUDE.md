...
> 🔴 이 문서(`CLAUDE.md`)는 **241,568자**입니다(2026-09-16 24시콜 ⓐ 전제 확정 직후) —
> 컨텍스트 예산 판단에 쓰는 값입니다. ⚠️ 그 직전에는 239,842자, 그 앞에는 236,835자였습니다.
...
| `docs/history/current.md` | 36차 PR 2 #151 2026-09-15  →  24시콜 v4 차수 변경 + 샘플 실측 2026-09-16   (9건) | 65,462자 |
