...
> 🔴 이 문서(`CLAUDE.md`)는 **200,139자**입니다(2026-09-22 §5 분리 직후) —
> 컨텍스트 예산 판단에 쓰는 값입니다. ⚠️ 바로 앞에는 **394,160자**였고, 그 앞은 393,241자였습니다.
...
> 로드맵 완료 차수 80건(`roadmap-done.md` 76,516자) · 차수별 요약 40건(`summaries.md` 119,488자).
> **한 글자도 안 지웠고** 옮긴 줄을 전수로 대조했습니다(빈 줄 뺀 3,119줄 일치 · 블록 단위 바이트 동일).
...
> ⚠️ **`current.md` 는 지금 49,360자입니다**(상한 80,000자 · 2026-09-22 실측) —
> 🟢 **상한까지 30,640자 여유가 있습니다.** 기록 한 건이 7,000~18,000자이니 **2~3건쯤** 들어갑니다.
...
| `docs/history/current.md` | 견적관리 전화응대 매뉴얼 #179 2026-09-18  →  CLAUDE.md §5 분리 2026-09-22   (6건) | 49,360자 |
| `docs/history/roadmap-done.md` | **§5 로드맵의 완료된 차수 80건** — 27차  →  알림 4건 #162 2026-09-16 | 76,516자 |
| `docs/history/summaries.md` | **§5 의 차수별 「이후 세션이 알아야 할 것만 요약」 40건** — #179  →  66차 | 119,488자 |
...
⚠️ **그 앞 40건의 요약(전화응대 매뉴얼 #179 → 66차 이용약관 개정)은 `docs/history/summaries.md` 로**
**옮겼습니다**(2026-09-22 · md5·바이트 대조). 🔴 **루트에 남긴 것은 최근 3건뿐이고 없앤 것이 아닙니다** —
「PR #NNN 이후 세션이 알아야 할 것」이 루트에 안 보이면 **그 파일을 먼저 볼 것.**
