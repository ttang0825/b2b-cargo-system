...
> 🔴 이 문서(`CLAUDE.md`)는 **324,173자**입니다(2026-09-17 수정견적 배지·수정 이력 #173 직후) —
> 컨텍스트 예산 판단에 쓰는 값입니다. ⚠️ 그 직전에는 316,337자, 그 앞에는 310,907자였습니다.
...
| `docs/history/current.md` | 포털 알림 4건 #164 2026-09-16  →  수정견적 배지·수정 이력 #173 2026-09-17   (8건) | 67,184자 |
