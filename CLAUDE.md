...
> 🔴 이 문서(`CLAUDE.md`)는 **266,051자**입니다(2026-09-16 견적번호 중복 #163 직후) —
> 컨텍스트 예산 판단에 쓰는 값입니다. ⚠️ 그 직전에는 261,898자, 그 앞에는 256,742자였습니다.
...
| `docs/history/current.md` | 운송오더 3건 2026-09-15  →  견적번호 중복 #163 2026-09-16   (9건) | 66,818자 |
