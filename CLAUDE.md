...
| `docs/history/current.md` | #129 2026-09-08  →  #135 2026-09-09   (7건) | 44,543자 |
...
```
  ...
  ——   운임기준표 v11 A장 (차수 없음)  ✅ 완료 (PR #135 merge `1da2663` —
        ...
        **마진율 컬럼을 만들지 말 것** — 공개 게시가에 원가가 나간다 ·
        ...
        게시가도 같이 돌아간다** ·
        🔴 **B장(혼적 3단계)은 아직이다** — `reverseMixedDiscount()` 호출부 **0곳** ·
        `standard_discount_percent` 는 **입력창 기본값일 뿐**이라 지시서 3-2 설계안을
        못 쓴다. **대안을 정한 뒤 착수할 것**)
...
```
  ...
  ③ 해당 차수의 세션 기록  🔴 **`docs/history/`** 에 있다 — §0 「이력 찾는 법」 표
                          최신은 `current.md` 최상단, 옛것은 `history-01~06.md`
```
