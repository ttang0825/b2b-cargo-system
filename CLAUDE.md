...
> 🔴 이 문서(`CLAUDE.md`)는 **256,742자**입니다(2026-09-16 화주포털 B장 웹 푸시 #161 직후) —
> 컨텍스트 예산 판단에 쓰는 값입니다. ⚠️ 그 직전에는 252,456자, 그 앞에는 246,209자였습니다.
...
| `docs/history/current.md` | 운송오더 3건 2026-09-15  →  화주포털 B장 웹 푸시 #161 2026-09-16   (7건) | 56,783자 |
