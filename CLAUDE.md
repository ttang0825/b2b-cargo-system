...
**작성일: 2026-07-23** (최종 갱신: 2026-07-29, Claude Code 세션에서 직접 갱신 — 5차
...
상차·하차 일시 저장 시 시간대(timezone)가 밀리던 버그 수정(아래 참고) 진행
중 — 3차
...
문구 추가, **혼적 할인 적용 방식 변경** — 최초엔 화주 청구운임 입력값은
...
빠져있던 `minDateTime` 제약(원칙 6번)도 함께 추가
