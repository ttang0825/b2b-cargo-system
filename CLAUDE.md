...
> 🔴 이 문서(`CLAUDE.md`)는 **365,053자**입니다(2026-09-18 전화응대 매뉴얼 #179 기록 직후) —
> 컨텍스트 예산 판단에 쓰는 값입니다. ⚠️ 그 직전에는 359,254자, 그 앞에는 354,200자였습니다.
> ⚠️ **`wc -m` 으로 세지 마십시오** — 이 환경은 locale 이 UTF-8 이 아니라 **바이트**가 나옵니다
> (한글 섞인 글은 실제의 약 1.9배). `python3` 의 `len()` 으로 세십시오.
> ⚠️ **`current.md` 를 `history-19.md` 로 갈랐습니다**(2026-09-18 · 랜딩 히어로 선명도 #169 ·
...
| `docs/history/current.md` | 배차취소 후속 #172 2026-09-17  →  전화응대 매뉴얼 #179 2026-09-18   (8건) | 70,809자 |
