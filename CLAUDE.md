...
**"전국 배차망 연계 · 다마스부터 5톤 이상까지"**로 교체(1·2번 줄과 스타일은 그대로).
...
`/vehicles` 다마스·라보 행, ~~레이아웃 개편·헤더 옐로·이미지~~ → **레이아웃 개편과 헤더
...
**(2) 차량 범위 표현 기준(중요)** — **"다마스·라보부터 1톤~5톤 이상까지"**로 적는다.
...
`/vehicles` 다마스·라보 행(시작가 확인 필요), SMS 문구 8종·견적서 PDF 용어 정리.
...
- ~~**7차: 확정 문구 교체**~~ — **32차 세션에서 완료**(상세는 위 32차 세션 기록 참고).
  ...
  - **차량 범위는 "다마스·라보부터 1톤~5톤 이상까지"** — "25톤"·"전 차종"은 쓰지 않음.
    ⚠️ **"1톤~5톤 이상"은 금지어가 아님**(상한을 닫지 않는 표현이라 일부러 이렇게 씀)
