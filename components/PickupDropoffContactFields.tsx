...
// 🚨 **다만 2026-09-18 부터 차주 「화물정보 안내」 문자 본문에 이 값이 찍힌다**
//    (`lib/sms/templates.ts` 의 `dispatchConfirmedMessage` · HANDOFF §5-25).
//    사용자 원문이 *「기입되어 있는 선안에서 상하차지 담당자 이름과 전화번호가 있어야
//    한다」* 라 **비면 그 줄이 통째로 빠진다** — 「미정」·「-」로 채우지 않는다.
//    🔴 **그래서 이 칸에 자리표시 문자열을 기본값으로 넣지 말 것** — 차주 문자에
//    그대로 나간다. 🔴 **필수로 되돌리지도 말 것**(34차 확정 · 위 문단).
