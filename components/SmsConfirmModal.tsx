    ...
    >
      ...
      >
        ...
        <div className="field" style={{ marginBottom: 10 }}>
          ...
          />
          {/* 90byte 초과를 빨간 경고로 띄우지 않는 이유 — 대부분이 설계상 LMS 라
              매번 뜨는 무의미한 경고가 된다. 종류만 담담히 보여주고, 한 화면에 안
              들어올 만큼 길어질 때(500byte 초과)만 주의를 준다.
              ⚠️ **「8종이 전부 LMS」는 2026-09-15 에 깨졌다** — 견적안내가 견적서
                 **링크 문자(87byte SMS)**로 바뀌었다. 그래서 이 표시가 실제로
                 「(SMS)」/「(LMS)」를 갈라 보여주는 자리가 됐다.
              🔴 담당자가 본문을 길게 고치면 90byte 를 넘겨 조용히 LMS 가 된다 —
                 이 한 줄이 그것을 알려주는 유일한 신호다. **지우지 말 것.** */}
          <div
            style={{
              fontSize: 11,
              marginTop: 4,
